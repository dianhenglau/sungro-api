...
public class ResultForSetUser implements Serializable {
    ...
    public enum Status {
        SUCCESS, INVALID_SESSION_ID, PERMISSION_DENIED, NOT_FOUND, MISSING_FIRST_NAME, MISSING_LAST_NAME, MISSING_EMAIL,
        INVALID_EMAIL, REPEATED_EMAIL, MISSING_ID_NUMBER, REPEATED_ID_NUMBER, MISSING_ID_TYPE, INVALID_ID_TYPE,
        MISSING_ROLE, INVALID_ROLE, MISSING_STATUS, INVALID_STATUS, SERVER_ERROR
    }
}
